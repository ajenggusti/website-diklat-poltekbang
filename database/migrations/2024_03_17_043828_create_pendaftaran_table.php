...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pendaftaran', function (Blueprint $table) {
            ...
            $table->enum('status_pembayaran_diklat', ['Lunas', 'Menunggu pembayaran', 'Dalam proses', 'lunas', 'sebagian'])->default('Menunggu pembayaran');
            ...
            $table->enum('status_pembayaran_daftar', ['Lunas', 'Menunggu pembayaran', 'Dalam proses', 'lunas', 'sebagian'])->default('Menunggu pembayaran');
