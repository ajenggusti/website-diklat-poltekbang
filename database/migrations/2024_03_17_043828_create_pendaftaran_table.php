...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pendaftaran', function (Blueprint $table) {
            ...
            $table->string('status_pembayaran_diklat'); //nnti isi dropdon
            ...
            $table->string('status_pembayaran_daftar'); //nnti isi dropdon
            $table->longText('pesan_email')->nullable();
            $table->bigInteger('kekurangan_diklat')->nullable();
            $table->bigInteger('kekurangan_daftar')->nullable();
