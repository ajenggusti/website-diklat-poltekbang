                ...
                <tr>
                    ...
                    <td>
                        @if ($diklatData->gambar)
                            ...
                            <img src="{{ asset('storage/' . $diklatData->gambar) }}" alt="" style="width: 500px; height: 250px;">
                        @else
                            @php $foundDefault = false; @endphp
                            @foreach ($allDiklatData as $data)
                                @if ($data->default == 'ya')
                                    <img src="{{ asset('storage/' . $data->gambar) }}" alt="Default Image" style="width: 500px; height: 250px;">
                            ...
                            @if (!$foundDefault)
                                ...
                                <img src="{{ asset('img/123.png') }}" alt="Default Image" style="width: 500px; height: 250px;">
                            @endif
                        @endif
                    </td>
                </tr>
