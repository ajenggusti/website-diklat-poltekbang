                ...
                <tr>
                    ...
                    <td>
                        @if ($diklatData->gambar)
                            ...
                            <img src="{{ asset('storage/' . $diklatData->gambar) }}" alt=""  style="width: 350px; height: 200px;">
                        @else
                            @php $foundDefault = false; @endphp
                            @foreach ($allDiklatData as $data)
                                @if ($data->default == 'ya')
                                    <img src="{{ asset('storage/' . $data->gambar) }}" alt="Default Image"  style="width: 350px; height: 200px;">
