                    ...
                    @auth
                        @if($detailDiklat->status== "full")
                            <div class="alert alert-danger" role="alert">
                                Mohon maaf, diklat ini sudah penuh.<a href="/" class="btn detail-one"> Lihat diklat yang lain?</a>
                            </div>
                        @elseif($dobelDiklat)
                            <div class="alert alert-warning" role="alert" style="border: 1px solid #000000">
                                Ups, kamu sudah mendaftar diklat ini.<a href="/riwayat" class="btn detail-two"> Lihat riwayat?</a>
                            </div>
                        @elseif($user->status!= "Diverifikasi")
                            <div class="alert alert-danger" role="alert">
                                Ups, data pribadimu belum Diverifikasi.<a href="/editProfil" class="btn detail-three"> Lengkapi data disini?</a>
                            </div>
                        @else
