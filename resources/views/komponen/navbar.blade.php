  ...
  <body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            // Tambahkan event listener untuk klik pada toggler
            navToggle.addEventListener('click', function() {
                navCollapse.classList.toggle('show');
            });

            // Tambahkan event listener untuk menutup menu saat area luar di klik
            ...
            // Perbaikan: Tambahkan event listener untuk menutup menu saat toggler diklik kembali
            navToggle.addEventListener('click', function() {
