...
function sortTable(n, dir) {
  ...
  var arrowUp = table.querySelectorAll('th i.fa-arrow-up');
  var arrowDown = table.querySelectorAll('th i.fa-arrow-down');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updatePagination() {
        ...
        if (numPages > 1) {
            ...
            var singlePageButton = document.createElement('li');
            singlePageButton.classList.add('page-item');
            singlePageButton.classList.add('active');
            singlePageButton.innerHTML = '<a class="page-link" href="#">1</a>';
