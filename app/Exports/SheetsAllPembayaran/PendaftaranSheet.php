...
class PendaftaranSheet implements FromQuery, WithMapping, WithHeadings, WithStyles, WithEvents
{
    protected $totalHargaSum = 0;

    public function query()
    {
        return Pembayaran::query()->where('status', 'Lunas')->where('jenis_pembayaran', 'pendaftaran');
    }
